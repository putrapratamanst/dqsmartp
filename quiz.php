                ...
                <div class="row">
                    ...
                    <br>
...

                        {
                            ...
                            echo "            <a href='uploadresult.php?no=$nomor&answer=$answer' onclick=\"this.style.pointerEvents='none'; document.getElementById('finishBtn').disabled=true; document.getElementById('finishBtn').innerHTML='Processing...'; document.getElementById('finishBtn').className='btn btn-secondary waves-effect waves-light';\">";

                            echo "                <button type=\"button\" class=\"btn btn-success waves-effect waves-light\" id=\"finishBtn\">FINISH</button>";
