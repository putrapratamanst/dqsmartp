...
":"Fill all the field in the bottom"; ?>
                    ...
                    <form name="form" action="prog_regis.php" method="GET">
                        ...
                        <div class="md-form-group">
                            ...
                            <label><?php echo $lang=="id"?"Nama Lengkap":"Full Name"; ?></label>
                        </div>
                        <div class="md-form-group">
                            <input id="phone" name="phone" type="text" class="md-input" required />
                            <label><?php echo $lang=="id"?"Nomor HP":"Phone Number"; ?></label>
                        </div>
                        <div class="md-form-group">
                            <input id="grade" name="grade" type="text" class="md-input" required />
                            <label><?php echo $lang=="id"?"Kelas":"Grade"; ?></label>
                        </div>
                        <div class="md-form-group">
                            <select id="gender" class="md-input form-select" name="gender">
                                <option value="Male"><?php echo $lang=="id"?"Laki laki":"Male"; ?></option>
                                <option value="Female"><?php echo $lang=="id"?"Perempuan":"Female"; ?></option>
                            </select>
                            <label>Gender</label>
                        </div>
                        <div class="md-form-group">
                        ...
                        <div class="md-form-group">
                            ...
                            <label><?php echo $lang=="id"?"Nama Sekolah":"School Name"; ?></label>
                        </div>
                        <div class="m-b-md">
                            <label class="md-check"> <input id="checkvoucher" type="checkbox" onclick="getcheck()" /><i class="primary"></i> <?php echo $lang=="id"?"Punya kode voucher?":"Have voucher code?"; ?></label>
                        </div>
                ...
                <div class="p-v-lg text-center">
                    <div><?php echo $lang=="id"?"Sudah memiliki akun?":"Already have an account?"; ?> <a ui-sref="access.signin" href="index.php" class="text-primary _600"><?php echo $lang=="id"?"Masuk":"Sign in"; ?></a></div>
                </div>
            </div>
