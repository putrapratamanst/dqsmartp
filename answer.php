                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box page-title-box-alt">
                            <h4 class="page-title">Answer List</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='editans.php?ID=$id'><button type=\"button\" class=\"btn btn-info rounded-pill waves-effect waves-light\"> <span class=\"btn-label\"><i class=\"mdi mdi-book-edit\"></i></span>EDIT</button></a></td>";
                                                $no++;
                                                echo "</tr>";
                                            }
                                        } else {
