...
$mails = $mails . "<img src=\"http://dq-smartplus.com/img/top-result.jpeg\" width=\"100%\"><br/>";
...
$mails = $mails . '<table width="100%">';
$mails = $mails . '<tr>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3>'.$lang=="id" ? "Tanggal Pembuatan Kartu Skor" : "Date of Score Card Generation" .'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3>'.$lang=="id" ? "Nama Pengguna" : "Username" .'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3>'.$lang=="id" ? "Sekolah" : "School" .'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '</tr>';

$mails = $mails . '<tr>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3 style="color:#0b93d5;">'.$generation.'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3 style="color:#0b93d5;">'.$username.'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '<td width="40%" style="text-align: right;">';
$mails = $mails . '<h3 style="color:#0b93d5;">'.$school.'</h3>';
$mails = $mails . '</td>';
$mails = $mails . '</tr>';
$mails = $mails . '</table>';

$mails = $mails . '<table style="border: 1px solid black; border-collapse: collapse;" width="100%">';
$mails = $mails . '<tr>';
$mails = $mails . '<td style="border: 1px solid black; border-collapse: collapse;width: 15%; background-color: grey">';
$mails = $mails . '<h3 style="color: white;margin: 5px 0px;">Your Total <br />DQ Score</h3>';
$mails = $mails . '<h1 style="color: orange">'.$nilaiself.'</h1>';
$mails = $mails . '</td>';
$mails = $mails . '<td rowspan="3" style="border: 1px solid black; border-collapse: collapse;width: 70%;">';
$mails = $mails . $image;
$mails = $mails . '</td>';
$mails = $mails . '<td rowspan="3" style="border: 1px solid black; border-collapse: collapse;width: 15%;">';
$mails = $mails . $image2;
$mails = $mails . '</td>';
$mails = $mails . '</tr>';
$mails = $mails . '<tr>';
$mails = $mails . '<td>';
$mails = $mails . '<h3 style="color: darkgray; margin: 5px 0px">School<br/>Average<br/>DQ Score</h3>';
$mails = $mails . '<h1 style="color: grey">'.$nilaischool.'</h1>';
$mails = $mails . '</td>';
$mails = $mails . '</tr>';
$mails = $mails . '<tr>';
$mails = $mails . '<td>';
$mails = $mails . '<h3 style="color: darkgray; margin: 5px 0px">School<br/>Class Average<br/>DQ Score</h3>';
$mails = $mails . '<h1 style="color: grey">'.$nilaiclass.'</h1>';
$mails = $mails . '</td>';
$mails = $mails . '</tr>';
$mails = $mails . '</table>';
...
$mails = $mails . '<table width="100%">
    <tr>
        <td style="width: 5%; background-color: grey; border: 1px solid white; border-collapse: collapse;" rowspan="2"><br /></td>
        <td style="width: 15%; background-color: grey; border: 1px solid white; border-collapse: collapse;" colspan="4"><br /></td>
    </tr>
    <tr>
        <td style="width: 15%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;">
            <center><h3 style="color: white;">Type</h3></center>
        </td>
        <td style="width: 20%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;">
            <center><h3 style="color: white;">Level</h3></center>
        </td>
        <td style="width: 55%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;">
            <center><h3 style="color: white;">Meaning</h3></center>
        </td>
        <td style="width: 5%; background-color: grey; border: 1px solid white; border-collapse: collapse;"></td>
    </tr>
</table>';
...
$mail->AddAddress("aryaubd@gmail.com", $username);  //tujuan email
$mail->MsgHTML($body);
//$mail->Send();
