            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    if($row['TIPE'] == 'Screen Time')
                    {
                        ...
                        elseif($row['TOTAL'] >= 85)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: #ed2207;'><center><h2>Less than Satisfactory<BR>KURANG MEMUASKAN</h2></center></td>";
                        ...
                        {
                            $mails = $mails . "<td style='width:20%; background-color: #c40010;'><center><h2>Requires Attention<BR>MEMBUTUHKAN PERHATIAN</h2></center></td>";
