                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" id="content">
                                ...
                                <form method="post" action="admin.php" id="frm2">
...
<script>
    ...
    function reset() {
        ...
        if ($hasil>0)
        {
            $sql = "SELECT * FROM `IMAGE` WHERE USERID = " . $_GET['ID'] . " ORDER BY UPLOAD_AT";
            $result = $conn->query($sql);
            $gambar = '';
            if ($result->num_rows > 0) {
            ...
            echo "$('#frm').html(\"Image not uploaded.\");";
            echo "$('#frm2').html(\"<img width='300' height='300' src='upload/$gambar'></br></br><button type='submit' class='btn btn-warning rounded-pill waves-effect waves-light'>BACK</button> \");";
