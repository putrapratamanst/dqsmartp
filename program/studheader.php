...
<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            <li>
                <a class="nav-link m-0<?php echo $lang=="en"?' active':""; ?>" href="#" onclick="changeLang('en')">EN</a>
            </li>
            <li>
                <a class="nav-link m-0<?php echo $lang=="id"?' active':""; ?>" href="#" onclick="changeLang('id')">ID</a>
            </li>
