...
$x = $pdf->GetX();
$y = $pdf->GetY();
$pdf->Image('img/topresult.PNG', 0, 0, 210);
$pdf->SetXY(3, $y + 25);
...
$pdf->Cell(68, 8, $lang=="en"?"Date of Score Card Generation":"Tanggal Pembuatan Kartu Skor", $border, 0, "C");
$pdf->Cell(68, 8, $lang=="en"?"Username":"Nama Pengguna", $border, 0, "C");
$pdf->Cell(68, 8, $lang=="en"?"School":"Nama Sekolah", $border, 1, "C");

$pdf->SetFont('Helvetica','B', 12);
$pdf->SetTextColor(11, 147, 213);
$pdf->Cell(68, 8, $generation, $border, 0, "C");
$pdf->Cell(68, 8, $usernameSession, $border, 0, "C");
$pdf->Cell(68, 8, $school, $border, 1, "C");
...
$pdf->Cell(50, 8, 'Type', 1, 0, 'C', 0, '', 0);
$pdf->Cell(40, 8, 'Level', 1, 0, 'C', 0, '', 0);
$pdf->Cell(114, 8, 'Meaning', 1, 1, 'C', 0, '', 0);
...
foreach($tempResult as $row){
    ...
    $h = $pdf->getStringHeight(114, $meaning, true, false, '', 0);
    $h = round($h + 1, 0);

    $pdf->Image($image, '', '', 50, $h, '', '', 'T', false, 300, '', false, false, 1, false, false, false);
    ...
    $pdf->MultiCell(40, $h, $level, 1, 'C', 0, 0, '', '', true, 0, false, true, 0, 'M', true);

    $pdf->SetTextColor(68, 68, 68);
    $pdf->SetFont('Helvetica','', 12);
    $pdf->MultiCell(114, $h, $meaning, 1, 'L', 0, 1, '', '', true, 0, false, true, 0, 'M');
}

$pdf->AddPage('P', 'A4');

$address = $lang=="en"?"img/result-en.webp":"img/result-id.webp";
$pdf->Cell(2, 8, "", $border, 0, "C");
