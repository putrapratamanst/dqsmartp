...
$mails = $mails . "<br><br><br><br><img src=\"http://dq-smartplus.com/img/top-result.jpeg\" width=\"100%\"> <br><table width=\"100%\"> <tr>";
...
$mails = $mails . $school;
$mails = $mails . "</font></h3></td></tr></table> <br><img src=\"http://dq-smartplus.com/img/middle-result.jpeg\" width=\"100%\"> <br><br><table style='border: 1px solid black; border-collapse: collapse;' width=\"100%\"> <tr> <td style=\"border: 1px solid black; border-collapse: collapse;width: 15%; background-color: grey\"><center><h2 style=\"color: white\">Your Total <br>DQ Score</h2><br><h1 style=\"color: orange\">106</h1></center></td><td rowspan=\"3\" style=\"border: 1px solid black; border-collapse: collapse;width: 70%;\"><img src=\"http://dq-smartplus.com/" . $_SESSION['gambar'] . "\" width='100%' height='100%'> </td><td rowspan=\"3\" style=\"border: 1px solid black; border-collapse: collapse; width: 15%;\"><img src=\"http://dq-smartplus.com/img/isitabelkanan.jpeg\" width=\"100%\" height=\"100%\"></td></tr><tr> <td><center><h2 style=\"color: darkgray;\">National<br>Average<br>DQ Score</h2><h1 style=\"color: grey\">106</h1></center></td></tr><tr> <td><center><h2 style=\"color: darkgray;\">Global Average<br>DQ Score</h2><h1 style=\"color: grey\">100</h1></center></td></tr></table>";
$mails - $mails . "<table width='100%'> <tr> <td style='width:5%'><br></td><td style='width:90%'> <table width='100%'> <tr> <td style='width: 5%; background-color: grey; border: 1px solid white; border-collapse: collapse;' rowspan='10'><br></td><td style='width:15%; background-color: grey; border: 1px solid white; border-collapse: collapse;' colspan='4'><br></td></tr><tr> <td style='width:15%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;'><center><h3 style='color: white'>Type</h3></center></td><td style='width:20%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;'><center><h3 style='color: white'>Level</h3></center></td><td style='width:55%; background-color: grey; color: White; border: 1px solid white; border-collapse: collapse;'><center><h3 style='color: white'>Meaning</h3></center></td><td style='width: 5%; background-color: grey; border: 1px solid white; border-collapse: collapse;'><br></td></tr>";
$sql = "SELECT TIPE, SUM(VALUE) AS TOTAL FROM RESULT AS A LEFT JOIN QUESTION AS B ON A.QUESTION = B.ID LEFT JOIN CATEGORY AS C ON B.TIPE = C.KATEGORI WHERE A.USERID = $ID GROUP BY B.TIPE ORDER BY C.ID";
            $result = $conn->query($sql);
            $nilai = '';
            $totnil = 0;
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $isx = $x + 1;
                    $mails = $mails . "<tr style='border: 1px solid grey; border-collapse: collapse;'>";
                    $mails = $mails . "<td style='width:15%; background-color: white;'><img src='res/type$isx.JPG'></td>";
                    if($x == 0)
                    {
                        if($row['TOTAL'] > 115)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Blue;'><center><h2>Excellent</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Management waktu menatap layar, mengukur kemampuan anda untuk mengelolawaktu menatap layar, multi tasking dan keterlibatan dalam berbagai aktifitas mediadigital dalam mengontrol diri. Skor management waktu menatap layar yang tinggi akan :<br>- Menyeimbangkan realitas fisik dan virtual<br>- Mengendalikan diri dalam penggunaan teknologi digital dan memahami berbagaieffek samping dari screen time yang berlebihan, multi tasking dan penggunaanmedia digital yang adiktif.<br>- Mampu mengatur waktu dan menetapkan batas penggunaan pribadi tanpamembiarkan penggunaan digital mengambil alih hidup anda.<br><br>Selamat! performa anda dalam kategori Screen Time Management ini sangat baik</td>";
                        }
                        elseif($row['TOTAL'] >= 110)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Green;'><center><h2>More Thank Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Management waktu menatap layar, mengukur kemampuan anda untuk mengelolawaktu menatap layar, multi tasking dan keterlibatan dalam berbagai aktifitas mediadigital dalam mengontrol diri. Skor management waktu menatap layar yang tinggi akan :<br>- Menyeimbangkan realitas fisik dan virtual<br>- Mengendalikan diri dalam penggunaan teknologi digital dan memahami berbagaieffek samping dari screen time yang berlebihan, multi tasking dan penggunaanmedia digital yang adiktif.<br>- Mampu mengatur waktu dan menetapkan batas penggunaan pribadi tanpamembiarkan penggunaan digital mengambil alih hidup anda.<br>Anda telah memahami dengan baik ! Prestasi anda dalam kategori Screen TimeManagement ini memuaskan.</td>";
                        }
                        elseif($row['TOTAL'] >= 85)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Yellow;'><center><h2>Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Management waktu menatap layar mengukur kemampuan anda untuk mengelolawaktu menatap layar, multi tasking dan keterlibatan dalam berbagai aktifitas mediadigital dalam mengontrol diri. Skor management waktu menatap layar yang tinggi akan :<br>- Menyeimbangkan realitas fisik dan virtual<br>- Mengendalikan diri dalam penggunaan teknologi digital dan memahami berbagaieffek samping dari screen time yang berlebihan, multi tasking dan penggunaanmedia digital yang adiktif.<br>- Mampu mengatur waktu dan menetapkan batas penggunaan pribadi tanpamembiarkan penggunaan digital mengambil alih hidup anda.<br><br>Prestasi anda dalam kategori ini kurang memuaskan dan masih harusdikembangkan agar dapat mengatur manajemen waktu dengan baik.</td>";
                        }
                        else
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Red;'><center><h2>Less Then Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Management waktu menatap layar, mengukur kemampuan anda untuk mengelolawaktu menatap layar, multi tasking dan keterlibatan dalam berbagai aktifitas mediadigital dalam mengontrol diri. Skor management waktu menatap layar yang tinggi akan :<br>- Menyeimbangkan realitas fisik dan virtual<br>- Mengendalikan diri dalam penggunaan teknologi digital dan memahami berbagaieffek samping dari screen time yang berlebihan, multi tasking dan penggunaanmedia digital yang adiktif.<br>- Mampu mengatur waktu dan menetapkan batas penggunaan pribadi tanpamembiarkan penggunaan digital mengambil alih hidup anda.<br><br>Anda belum siap melakukan pengendalian diri saat menggunakan media digital.</td>";
                        }
                    }
                    elseif($x == 1)
                    {
                    ...
                    elseif($x == 3)
                    {
                        ...
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Blue;'><center><h2>Excellent</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Digital Citizen Identity mengukur kemampuan anda untuk membangun dan mengelola identities yang sehat dan berintegritas secara online dan offline. Anda dengan skor Digital Citizen Identity yang tinggi akan :<br>- Memahami sifat dunia digital dan menggunakan teknologi dan dunia digitaldengan percaya diri yang kuat.<br>- Memiliki pengetahuan dan ketrampilan untuk membangun dan mengelolaidentitas yang sehat.<br>- Menyadari menjadi warga negara global diruang digital.<br><br>Selamat! performa anda dalam kategori ini sangat baik, terima kasih telahmendukung pemahaman yang kuat tentang Digital Citizen Identity Skill dengan baik.</td>";
                        }
                        elseif($row['TOTAL'] >= 110)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Green;'><center><h2>More Thank Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Digital Citizen Identity mengukur kemampuan anda untuk membangun dan mengelola identities yang sehat dan berintegritas secara online dan offline. Anda dengan skor Digital Citizen Identity yang tinggi akan :<br>- Memahami sifat dunia digital dan menggunakan teknologi dan dunia digitaldengan percaya diri yang kuat.<br>- Memiliki pengetahuan dan ketrampilan untuk membangun dan mengelolaidentitas yang sehat.<br>- Menyadari menjadi warga negara global diruang digital.<br><br>Anda telah memahami dengan baik Digital Citizen Identity Skill ! Prestasi andadalam kategori ini memuaskan.</td>";
                        }
                        elseif($row['TOTAL'] >= 85)
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Yellow;'><center><h2>Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Digital Citizen Identity mengukur kemampuan anda untuk membangun dan mengelola identities yang sehat dan berintegritas secara online dan offline. Anda dengan skor Digital Citizen Identity yang tinggi akan :<br>- Memahami sifat dunia digital dan menggunakan teknologi dan dunia digitaldengan percaya diri yang kuat.<br>- Memiliki pengetahuan dan ketrampilan untuk membangun dan mengelolaidentitas yang sehat.<br>- Menyadari menjadi warga negara global diruang digital.<br><br>Prestasi anda dalam Digital Citizen Identity Skill ini kurang memuaskan dan masih harus dikembangkan.</td>";
                        }
                        else
                        {
                            $mails = $mails . "<td style='width:20%; background-color: Red;'><center><h2>Less Then Satisfactory</h2></center></td>";
                            $mails = $mails . "<td style='width:50%; background-color: White;'>Digital Citizen Identity mengukur kemampuan anda untuk membangun dan mengelola identities yang sehat dan berintegritas secara online dan offline. Anda dengan skor Digital Citizen Identity yang tinggi akan :<br>- Memahami sifat dunia digital dan menggunakan teknologi dan dunia digitaldengan percaya diri yang kuat.<br>- Memiliki pengetahuan dan ketrampilan untuk membangun dan mengelolaidentitas yang sehat.<br>- Menyadari menjadi warga negara global diruang digital.<br><br>Anda belum siap melakukan pengendalian diri saat menggunakan media digital.</td>";
                        }
                    }
                    elseif($x == 4)
                    {
...
if($mail->Send()) 
{
    ...
    header("location: result.php?sukses=Message has been sent");
    exit();
}
else 
{
    ...
    $br++;
    include 'program/close.php';
    header("location: result.php?error=Failed");
    exit();
}
?>