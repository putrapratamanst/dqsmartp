...
class MYPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        // Page number
        $this->Cell(0, 6, 'Page '.$this->getAliasNumPage().' of '.$this->getAliasNbPages() . " - http://dq-smartplus.com - " . date("d M Y H:i"), 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
}
...
$mail->AddAddress("aryaubd@gmail.com", "test");
$mail->MsgHTML($body);
$mail->Send();
