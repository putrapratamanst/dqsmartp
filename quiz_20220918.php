                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                if ($nos == $jawaban)
                                                {
                                                    echo "<a href='picker.php?pick=$nos&no=$nomor&answer=$answer&type=$type'><button type=\"button\" style='width: 50%;' class=\"btn btn-warning waves-effect waves-light $anx\">" . $row['ANSWER'] . "</button></a>";
                                                    echo "<br>";
                                                    echo "<br>";
                                                }
                                                else
                                                {
                                                    echo "<a href='picker.php?pick=$nos&no=$nomor&answer=$answer&type=$type'><button type=\"button\" style='width: 50%;' class=\"btn btn-success waves-effect waves-light $anx\">" . $row['ANSWER'] . "</button></a>";
                                                    echo "<br>";
                                                    echo "<br>";
                                                }
                                                $nos++;
